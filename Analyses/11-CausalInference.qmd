...
causalDiagram1 <- ggdag::dagify(
  coachConfidenceInPlayer ~ pastPerformance + injuryStatus,
  snapShare ~ coachConfidenceInPlayer,
  touchesOrTargets ~ snapShare,
  fantasyPoints ~ touchesOrTargets
)
...
quarterbackIQ ~ age + nutrition,
averageTimeToThrow ~ quarterbackIQ + age + offensiveLineStrength + defensiveLineStrength
...
dagitty::adjustmentSets(
  causalDiagram2,
  exposure = "quarterbackIQ",
  outcome = "averageTimeToThrow",
  effect = "total")
```
