...
petersenlab::accuracyAtCutoff(
  ...
  actual = player_stats_weekly_example$rush_150_yds,
  cutoff = 100
)
```
...
- sensitivity (SN) "Increase"
- specificity (SP) "Decrease"
- positive predictive value (PPV) "Decrease"
- negative predictive value (NPV) "Increase"
...
- sensitivity (SN) "Decrease"
- specificity (SP) "Increase"
- positive predictive value (PPV) "Increase"
- negative predictive value (NPV) "Increase"
