...
linearRegression_multiplePredictors <- lm(
  receptions ~ fantasyPoints + ageCentered20 + ageCentered20Quadratic + years_of_experience + receiving_yards + receiving_tds + receiving_air_yards + receiving_yards_after_catch + racr + targets + target_share, # RACR = receiving_yards / receiving_air_yards
